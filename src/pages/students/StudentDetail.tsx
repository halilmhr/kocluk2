...
const StudentDetail: React.FC = () => {
  ...
  // Debug için log'lar
  console.log('StudentDetail - Debug Info:');
  console.log('studentId:', studentId);
  console.log('students:', students);
  console.log('student:', student);
  console.log('studentBooks:', studentBooks);
  console.log('books:', books);
  console.log('studentBooksData:', books.filter(b => studentBooks.map(sb => sb.book_id).includes(b.id)));
