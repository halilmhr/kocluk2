  ...
  const handleExamSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedExamType === 'TYT') {
        ...
        // Fen Bilimleri - Fizik ayrı kaydet
        await saveSingleSubjectExam(studentId, 'AYT', {
          examName: examName + ' - Fizik',
          subject: 'Fizik',
        ...
        // Fen Bilimleri - Kimya ayrı kaydet
        await saveSingleSubjectExam(studentId, 'AYT', {
          examName: examName + ' - Kimya',
          subject: 'Kimya',
          correct: parseInt(aytData.fenBilimleri.kimya.correct) || 0,
          wrong: parseInt(aytData.fenBilimleri.kimya.wrong) || 0,
          blank: parseInt(aytData.fenBilimleri.kimya.blank) || 0
        });
        
        // Fen Bilimleri - Biyoloji ayrı kaydet
        await saveSingleSubjectExam(studentId, 'AYT', {
          examName: examName + ' - Biyoloji',
          subject: 'Biyoloji',
          correct: parseInt(aytData.fenBilimleri.biyoloji.correct) || 0,
          wrong: parseInt(aytData.fenBilimleri.biyoloji.wrong) || 0,
          blank: parseInt(aytData.fenBilimleri.biyoloji.blank) || 0
        });
      }
